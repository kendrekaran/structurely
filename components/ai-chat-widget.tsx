    ...
    <AnimatePresence>
      {visible ? (
        <motion.div
          ...
          className="fixed right-0 bottom-0 z-50 w-[403px] max-w-full px-4.5 py-2.5"
        >
          <div className="rounded-[20px] border border-[#E5E7EB] bg-white/72 p-3 backdrop-blur-md">
