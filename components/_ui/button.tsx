...
const buttonVariants = cva(
  "font-medium leading-[20px] whitespace-nowrap transition-all active:scale-[0.98] cursor-pointer",
  {
    variants: {
      variant: {
        primary:
          "px-3 py-1.5 sm:px-[20px] sm:py-[12px]  rounded-[12px] bg-[#4B7BFF] border border-[#4B7BFF] text-white",
        secondary:
        ...
        outline:
          "rounded-[10px] py-[8px] px-[18px] border border-[#4B7BFF] text-[#4B7BFF] bg-transparent",
      },
      size: {
