...
const features = [
  ...
  },
  {
    ...
    description:
      "AI sets followups within a lead's timeframe if they're not ready now.",
    active: true,
    icon: (
      <svg
        width="24"
...
function PowerDialerSection() {
  return (
    <div className="px-global">
      ...
      >
        <div className="flex flex-col items-center gap-3 px-6 py-16 md:px-24">
          <div
        ...
        <div className="relative flex items-stretch border-y border-[#E5E7EB]">
          ...
          <div className="flex w-full flex-col divide-y divide-[#E5E7EB] md:flex-row md:divide-y-0">
