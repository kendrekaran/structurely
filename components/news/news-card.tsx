  ...
  const content = (
    <div className="bg-white">
      ...
      <div className="flex flex-col divide-y divide-[#E5E7EB]">
        <div className="flex flex-col gap-2 p-6 px-3 md:px-6">
          <h3 className="line-clamp-1 text-[16px] leading-[26px] font-medium tracking-[-0.01em]">
            {title}
          </h3>
          <p className="line-clamp-3 text-[14px] leading-[24px] tracking-[-0.006em]">
            {description}
          </p>
        </div>
        <div className="p-6">
