          ...
          {syncItems.map((item, index) => (
            <div key={item.label} className="flex items-center flex-1 min-w-[120px]">
              <div className="flex flex-col justify-center items-center gap-6 flex-1 px-6 md:px-12 py-8">
                <div className="flex p-2 md:p-3 items-center gap-2 rounded-[10px] bg-white shadow-[0_0_0_1px_rgba(0,0,0,0.08),0_1px_1px_-0.5px_rgba(51,51,51,0.05),0_3px_3px_-1.5px_rgba(51,51,51,0.05),0_6px_6px_-3px_rgba(51,51,51,0.05),0_12px_12px_-6px_rgba(51,51,51,0.05),0_24px_24px_-12px_rgba(51,51,51,0.05)]">
                  <img
                    src={item.icon}
                    alt={item.label}
                    width={24}
