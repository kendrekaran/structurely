        ...
        <div className="max-w-global mx-auto border-x border-[#E5E7EB] pt-16 pb-0">
          ...
          <div className="grid grid-cols-1 divide-y divide-[#E5E7EB] border-t border-[#E5E7EB] md:grid-cols-2 md:divide-x md:divide-y-0">
            {options.map((option) => (
              ...
              >
                <div
                  className={`flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-[10px] bg-white ${cardShadow}`}
                >
                  <option.Icon />
                </div>
                <div className="flex flex-col gap-0.5">
                  <span className="text-[14px] leading-5 font-medium tracking-[-0.01em] text-[#202020]">
                    {option.title}
                  </span>
                  <div className="text-[13px] leading-5 tracking-[-0.01em]">
                    {option.description}
                  </div>
                </div>
              </div>
