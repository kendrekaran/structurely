    ...
    <section id="knowledge-bases" className="relative z-0">
      <div className="px-global">
        <div className="max-w-global mx-auto border-x border-b border-[#E5E7EB]">
          ...
          <div className="flex flex-col items-center px-6 py-8 pb-[64px]">
          ...
          <div className="flex flex-col items-center gap-3 border-t border-[#E5E7EB] px-24 py-6 ">
            <p className="text-center">Did this answer your question?</p>
