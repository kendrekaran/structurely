  ...
  },
  {
    ...
    icon: (
      ...
      >
        ...
        />
        <path
          d="M9.09009 8.99959C9.32519 8.33126 9.78924 7.7677 10.4 7.40873C11.0108 7.04975 11.729 6.91853 12.4273 7.0383C13.1255 7.15808 13.7589 7.52112 14.2152 8.06312C14.6714 8.60512 14.9211 9.29112 14.9201 9.99959C14.9201 11.9996 11.9201 12.9996 11.9201 12.9996"
          stroke="#006FFF"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
...
function CategoryCard({ category }: { category: (typeof categories)[0] }) {
  return (
    <div
      className={`flex flex-col items-center justify-center gap-6 px-12 py-8 ${category.bg}`}
    >
