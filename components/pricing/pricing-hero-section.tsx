...
const checkmarkIcon = (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M5.625 10.8855L8.25 13.5417L14.375 6.45837" stroke="#006FFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
        ...
        <div className="max-w-global mx-auto border-x border-[#E5E7EB]">
          ...
          <div className="mt-10 flex flex-wrap justify-center items-center gap-1 md:gap-3 md:px-6 py-6 border-t border-[#E5E7EB] bg-white">
            {featureItems.map((item) => (
              ...
              >
                {checkmarkIcon}
                <span className="text-[14px] leading-5 font-medium text-[#646464] tracking-[-0.006em]">
                  {item}
                </span>
              </div>
            ))}
