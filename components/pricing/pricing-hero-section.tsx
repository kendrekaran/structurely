...
export default function PricingHeroSection({ billing, onBillingChange }: PricingHeroSectionProps) {
  return (
    <section id="pricing-hero" className="relative z-0 border-b border-[#E5E7EB] bg-white">
      <div className="px-global py-section-md">
        <div className="max-w-global mx-auto flex flex-col items-center gap-10">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="flex p-0.5 rounded-full bg-[rgba(32,32,32,0.08)]">
              <button
                onClick={() => onBillingChange("monthly")}
                className={`w-24 py-1.5 px-5 rounded-full text-[14px] font-medium leading-5 transition-all cursor-pointer ${
                  billing === "monthly"
            ...
            <p className="text-[14px] leading-5 tracking-[-0.01em] text-center">
              <span className="text-[#646464]">Save </span>
              <span className="text-[#202020] font-semibold">20%</span>
