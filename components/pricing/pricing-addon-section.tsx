...
const topFeatures = [
  {
    ...
    icon: (
      ...
      >
        ...
        />
        <path
          d="M2 18H3.973C4.61949 18.0044 5.25742 17.852 5.83215 17.556C6.40687 17.2599 6.90127 16.8289 7.273 16.3L12.727 7.69997C13.0987 7.17102 13.5931 6.74005 14.1679 6.44398C14.7426 6.14791 15.3805 5.99556 16.027 5.99997H22"
          stroke="#006FFF"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M2 5.99997H3.972C4.71746 5.99479 5.44954 6.19802 6.08564 6.58675C6.72174 6.97548 7.23655 7.53423 7.572 8.19997"
          stroke="#006FFF"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M21.9998 18H15.9588C15.3034 17.9933 14.6596 17.8257 14.0842 17.5118C13.5088 17.1979 13.0193 16.7474 12.6588 16.2L12.2998 15.75"
          stroke="#006FFF"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M4.00024 10C3.18469 11.3951 2.85438 13.0211 3.06097 14.6238C3.26755 16.2265 3.99938 17.7155 5.14204 18.8582C6.2847 20.0009 7.77378 20.7327 9.37648 20.9393C10.9792 21.1459 12.6052 20.8156 14.0002 20L4.00024 10Z"
          stroke="#006FFF"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="M17 13C17 11.4087 16.3679 9.88258 15.2426 8.75736C14.1174 7.63214 12.5913 7 11 7"
          stroke="#006FFF"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M21 13C21 10.3478 19.9464 7.8043 18.0711 5.92893C16.1957 4.05357 13.6522 3 11 3"
          stroke="#006FFF"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
          ...
          <div className="flex flex-col lg:flex-row">
            <div className="flex flex-1 flex-col justify-center gap-4 p-8 px-[12px] md:p-12 md:px-8 md:py-[87px]">
              ...
              <div className="flex flex-col gap-1">
                <p className="text-[16px] leading-[26px] font-medium tracking-[-0.01em] text-[#202020]">
                  Create a list, flip the switch, and let AI start dialing.
                  Toggle back to your team anytime.
                </p>
                <p className="text-[14px] leading-[24px] tracking-[-0.01em] text-[#646464]">
                  No new platform. No new workflow. Just more conversations — at
                  scale.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-3">
                <div className="mt-2 flex items-center gap-3">
                  <span
                    className={`text-[16px] leading-[26px] font-medium tracking-[-0.01em] transition-colors ${mode === "human" ? "text-[#006FFF]" : "text-[#646464]"}`}
                  >
                    Human
                  </span>
                  <button
                  ...
                  >
                    <span
                      ...
                      style={{
                        left: mode === "human" ? "4px" : "calc(100% - 36px)",
                      }}
                    />
                  </button>
                  <span
                    className={`text-[16px] leading-[26px] font-medium tracking-[-0.01em] transition-colors ${mode === "ai" ? "text-[#006FFF]" : "text-[#646464]"}`}
                  >
                    AI
                  </span>
                </div>
            ...
            <div className="flex flex-col items-center justify-center px-3 pb-[56px] md:p-12 md:pb-0">
              <div className="flex w-full flex-col items-center justify-center gap-4 rounded-[10px] border border-[#E5E7EB] bg-white px-8 py-[55px] shadow-[0_0_0_1px_rgba(0,0,0,0.08)] md:w-[289px] md:py-[31px]">
                <div className="flex w-full flex-col items-center gap-3">
                  <div className="flex flex-col items-center gap-2">
                    <span className="text-[16px] leading-6 font-medium tracking-[-0.006em] text-[#646464]">
                      AI power dialer
                    </span>
