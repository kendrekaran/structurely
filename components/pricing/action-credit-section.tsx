...
function SmsIcon() {
  return (
    ...
    >
      ...
      />
      <circle cx="8" cy="10" r="1" fill="#4B7BFF" />
      <circle cx="12" cy="10" r="1" fill="#4B7BFF" />
      <circle cx="16" cy="10" r="1" fill="#4B7BFF" />
    </svg>
  );
}
      ...
      <div className="px-global">
        <div className="max-w-global py-section-md mx-auto flex flex-col items-center gap-4 border-x border-[#E5E7EB]">
          <h2 className="max-w-[12em] text-center">
            What is an <span className="text-[#4B7BFF]">Action Credit?</span>
          </h2>
