  ...
  return (
    <section id="pilot" className="relative z-0 border-t border-[#E5E7EB]">
      <div className="px-global">
        <div className="max-w-global py-section-md mx-auto flex flex-col border-b-[2px] border-b-[#006FFF] items-center gap-6 border-x border-[#E5E7EB]">
          <div className="flex flex-col items-center gap-3">
            <h2 className="max-w-[12em] text-foreground  text-center">
              Not ready to commit?{" "}
