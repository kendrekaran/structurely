        ...
        <div className="max-w-global mx-auto border-x border-[#E5E7EB]">
          <div className="py-[80px] flex flex-col items-center gap-8">
            <div className="flex flex-col items-center gap-3.5">
              ...
              AI That Captures, Qualifies, Follows Up, 
              and Converts Inbound Demand.
              </h1>

              <p className="max-w-[38em] text-center">
                <span className="text-[#202020] ">Structurely AI 3</span>{" "}
                helps businesses capture, qualify, follow-up and convert inbound{" "}
