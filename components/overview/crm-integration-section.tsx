...
function CrmIntegrationSection() {
  return (
    ...
    <section id="crm-integration" className="max-w-global mx-auto border-x border-[#E5E7EB] border-b flex flex-col items-start ">
      ...
      <div className="flex bg-[#ffffff] items-center justify-center self-stretch border-t border-[#E5E7EB] px-6 py-5 md:px-24">
        <p className="text-center text-[14px] leading-6 md:text-[14px]">
          <span className="text-[#006FFF] font-medium">Structurely AI 3 works</span>{" "}
          inside your existing system.
        </p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 self-stretch border-t border-[#E5E7EB]">
        {features.map((feature, index) => {
          ...
          return (
            <div
              key={feature.label}
              className={[
                "flex flex-col items-center gap-4 px-8 py-10 border-[#E5E7EB]",
                "border-b lg:border-b",
                isLastRow ? "lg:border-b-0" : "",
                isRightColSm ? "" : "sm:border-r",
                isRightColLg ? "lg:border-r-0" : isMidColLg ? "lg:border-r" : "lg:border-r",
              ]
                .filter(Boolean)
                .join(" ")}
            >
