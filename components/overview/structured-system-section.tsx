...
function StructuredSystemSection() {
  return (
    <div className="px-global">
      ...
      >
        <div className="flex flex-col items-center justify-center gap-3 self-stretch px-6 py-section-md md:px-24">
            ...
            >
              <div className="self-stretch p-1">
                <div className="flex h-[240px] items-center justify-center overflow-hidden rounded-md bg-white shadow-[0_0_0_1px_rgba(0,0,0,0.08)]">
                  <span className="text-[16px] leading-6 tracking-[-0.01em] text-[#646464]">
                    Graphic
                  </span>
                </div>
              </div>
