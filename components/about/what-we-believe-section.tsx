function WhatWeBelieveSection() {
  return (
    <section id="what-we-believe" className="relative z-0">
          ...
          <div className="px-global">
            <div className="max-w-global mx-auto border-x border-[#E5E7EB]">
              <div className="grid grid-cols-1 divide-y divide-[#E5E7EB] md:grid-cols-3 md:divide-x md:divide-y-0">
                <div className="flex max-h-[84px] w-full items-center justify-center px-[12px] py-6 last:pr-0 md:px-[40px] md:py-[32px] md:last:px-8">
                  <p className="text-[14px] leading-[20px] tracking-[-0.01em]">
                    It deserves timely engagement.
                  </p>
                </div>
                <div className="flex max-h-[84px] w-full items-center justify-center px-[12px] py-6 md:px-8 md:py-8">
                  <p className="text-[14px] leading-[20px] tracking-[-0.01em]">
                    It requires consistent qualification.
                  </p>
                </div>
                <div className="flex max-h-[84px] w-full items-center justify-center px-[12px] py-6 first:pl-0 last:pr-0 md:px-8 md:py-8">
      ...
      <div className="border-b border-[#E5E7EB]">
        <div className="px-global">
          <div className="max-w-global mx-auto flex justify-center border-x border-[#E5E7EB] py-[24px]">
