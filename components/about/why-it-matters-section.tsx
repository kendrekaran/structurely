    ...
    <section id="why-it-matters" className="relative z-0">
      <div className="border-b border-[#E5E7EB]">
        <div className="px-global">
          <div className="max-w-global md:py-section-md mx-auto flex flex-col items-center gap-3 border-x border-[#E5E7EB] py-[24px] text-center">
            <h2
              data-reveal="words"
              className="max-w-[11em] text-[28px] leading-[36px] tracking-[-0.02em] md:text-[48px] md:leading-[54px] md:tracking-[-0.03em]"
            >
              Why it matters
            </h2>
            <p className="w-full max-w-[27.375em] px-[12px] text-center md:max-w-[488px]">
      ...
      <div className="border-b border-[#E5E7EB]">
        <div className="px-global">
          <div className="max-w-global mx-auto flex flex-col divide-y divide-[#E5E7EB] border-x border-[#E5E7EB] bg-white md:flex-row md:divide-x md:divide-y-0">
            {facts.map((fact) => (
              <div
                key={fact}
      ...
      <div className="border-b border-[#E5E7EB]">
        <div className="px-global">
          <div className="max-w-global mx-auto flex flex-col items-center gap-4 border-x border-[#E5E7EB] px-[12px] py-6 text-center md:gap-3">
