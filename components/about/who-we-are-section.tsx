...
function WhoWeAreSection() {
  return (
    <section id="who-we-are" className="relative z-0">
      ...
      <div className="border-b border-[#E5E7EB]">
        <div className="px-global">
          <div className="max-w-global mx-auto flex flex-col items-stretch border-x border-[#E5E7EB] md:flex-row">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3">
                  <p className="max-w-[27.375em] text-[16px] leading-[26px] tracking-[-0.01em] text-[#202020]">
                    Our work is grounded in real-world sales environments —
                    where response time, follow-up, and consistency directly
                    affect outcomes.
                  </p>
