    ...
    <section id="about-hero" className="relative z-0">
      <div className="px-global ">
        <div className="max-w-global mx-auto flex flex-col items-center gap-4 border-x border-[#E5E7EB] py-section-md text-center">
          ...
          <p className="max-w-[27.6em] text-[18px] leading-[28px] tracking-[-0.01em] text-center">
            For over a decade, Structurely has helped businesses capture,
            qualify, follow-up and convert inbound demand.
          </p>
        </div>
        <div className=" ">
        <div className=" max-w-global mx-auto border border-[#E5E7EB] bg-[#FFFFFF] flex items-center justify-center  py-[24px] ">
