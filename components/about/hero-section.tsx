    ...
    <section id="about-hero" className="relative z-0">
      <div className="px-global">
        <div className="max-w-global md:py-section-md mx-auto flex flex-col items-center gap-3.5 border-x border-[#E5E7EB] py-[40px] text-center md:gap-4">
          <h2
            data-reveal="words"
            className="max-w-[11.08em] text-center text-[32px] leading-[44px] font-normal tracking-[-0.04em] md:text-[48px] md:leading-[54px] md:font-medium md:tracking-[-0.03em]"
          >
            Structurely
          </h2>
      ...
      <div className="border-y border-[#E5E7EB] ">
        <div className="px-global">
          <div className="max-w-global bg-[#FFFFFF] mx-auto flex items-center justify-center border-x border-[#E5E7EB] px-[12px] py-[24px]">
